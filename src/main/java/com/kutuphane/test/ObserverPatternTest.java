...
public class ObserverPatternTest {
    ...
    public void testObserverPattern() {
        ...
        String ogrenciNo1 = "12345678901"; // Ahmet Yilmaz
        String isbn1 = "9780000000001"; // Gece Yarisi Kutuphanesi
        ...
        // Eğer kitap zaten ödünç alınmışsa, önce iade edip tekrar deneyelim
        if (!oduncAlmaSonucu1) {
