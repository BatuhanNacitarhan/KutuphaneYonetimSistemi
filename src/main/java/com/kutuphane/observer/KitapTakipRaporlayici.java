...
public class KitapTakipRaporlayici implements KitapTakipObserver {
    private Map<String, Integer> kitapOduncSayisi; // Kitap ISBN -> Ödünç alma sayısı
    private Map<String, Integer> kullaniciOduncSayisi; // Kullanıcı ID -> Ödünç alma sayısı
